...
const TPL_IMAGE_COPY = [
  ...
  },
  {
    name: '富文本与关联图',
    rows: [
      { label: '富文本段落 1-标题', example: '一周用药，清晰规划', desc: 'A+ 模块段落标题', required: false },
      { label: '富文本段落 1-卖点展示', example: '7 格分区帮助用户把一周药物提前整理好', desc: 'A+ 模块正文（30-100 字）', required: false },
      { label: '富文本段落 1-图片', example: '建议关联图2容量说明与一周分区示意', desc: '该段落配图/关联图说明', required: false },
      { label: '富文本段落 1-文案', example: 'Plan Your Week in One Go', desc: 'A+ 模块展示文案', required: false },
      { label: '富文本段落 2-标题', example: '大容量不笨重', desc: '', required: false },
      { label: '富文本段落 2-卖点展示', example: '兼顾多药收纳和日常便携', desc: '', required: false },
      { label: '富文本段落 2-图片', example: '建议关联图6手持/包内尺寸对比', desc: '', required: false },
      { label: '富文本段落 2-文案', example: '', desc: '', required: false },
      { label: '富文本段落 3-标题', example: '带得出门的安心感', desc: '', required: false },
      { label: '富文本段落 3-卖点展示', example: '稳固卡扣与紧凑结构适合放入包内', desc: '', required: false },
      { label: '富文本段落 3-图片', example: '建议关联图3卡扣结构与旅行场景', desc: '', required: false },
      { label: '富文本段落 3-文案', example: '', desc: '', required: false },
    ],
  },
];
...
// ===== 模板 A_OPT：优化卖点图片（与新品四字段对齐） =====
const TPL_IMAGE_COPY_OPT = [
  {
    name: '基础信息',
    rows: [
      { label: 'SKU', example: 'PO17X4011', desc: '产品 SKU 编码', required: true },
      { label: '站点', example: 'Amazon US', desc: '目标站点', required: true },
      { label: '备注', example: '优先赶在本周上架前完成主图与图3', desc: '其他说明', required: false },
    ],
  },
  {
    name: '卖点图片优化',
    rows: [
      { label: '图位 1-图位名', example: '主图', desc: '待优化的图片位置，如主图、图2、图3…', required: true },
      { label: '图位 1-卖点展示', example: 'CTR 偏低，需强化 7 格分区 + 黑色专业质感 + AUVON logo', desc: '优化后期望的卖点展示', required: true },
      { label: '图位 1-图片', example: 'https://www.amazon.com/dp/B07YYYY1234', desc: '图片设计要求或参考说明', required: false },
      { label: '图位 1-文案', example: '7-Day Pill Organizer · Large Compartments · Travel Ready', desc: '当前线上或期望文案', required: true },
      { label: '图位 2-图位名', example: '图3', desc: '第二张待优化图位', required: false },
      { label: '图位 2-卖点展示', example: '放大卡扣特写并补充包内携带场景', desc: '', required: false },
      { label: '图位 2-图片', example: '', desc: '', required: false },
      { label: '图位 2-文案', example: '展示卡扣结构与防洒携带场景', desc: '', required: false },
    ],
  },
  {
    name: '富文本优化',
    rows: [
      { label: '富文本 1-卖点展示', example: '7 格分区帮助用户把一周药物提前整理好，减少漏服焦虑', desc: 'A+ 段落优化后的卖点展示', required: false },
      { label: '富文本 1-图片', example: '建议关联图2容量说明与一周分区示意', desc: '该段落配图/关联图说明', required: false },
      { label: '富文本 1-文案', example: 'Plan Your Week in One Go — Seven clearly labeled compartments…', desc: 'A+ 模块展示文案', required: false },
      { label: '富文本 2-卖点展示', example: '', desc: '', required: false },
      { label: '富文本 2-图片', example: '', desc: '', required: false },
      { label: '富文本 2-文案', example: '', desc: '', required: false },
    ],
  },
];
...
// reqKey 形如：new-listing7 / old-listing7 / new-titletd-titletd / new-video-selling / new-faq / new-package
function getInputTemplateKey(reqKey) {
  ...
  const biz = parts[1];
  const sub = parts[2];
  if (biz === 'listing7' && stage === 'old') return 'A_OPT';
