...
const COPY_REVIEW_LIST_DATA = [
  { type: '新品Listing', site: 'US', brand: 'AUVON', sub: '药盒', name: '7格大容量粉色',       sku: 'PO17X4011', productImage: 'https://picsum.photos/seed/cr-pillbox-pink/144/144',       productImageAlt: '7格大容量粉色药盒主图', review_status: '待审核', bu: '物理治疗', bu_lead: 'Suki', op: 'Jessi', writer: 'Yumi',  launch_date: '2026/02/20', date: '2026/02/12', submit_time: '2026/02/08 10:15:42', review_time: '—' },
  { type: '新品图片文案', site: 'US', brand: 'AUVON', sub: '电疗', name: '伤口贴 10pack',       sku: 'PO17X4011', productImage: 'https://picsum.photos/seed/cr-wound-patch/144/144',         productImageAlt: '伤口贴 10pack 主图', review_status: '待审核', bu: '物理治疗', bu_lead: 'Suki', op: 'Jessi', writer: 'Yumi',  launch_date: '2026/02/22', date: '2026/02/12', submit_time: '2026/02/07 14:20:33', review_time: '—' },
  { type: '新品图片文案', site: 'US', brand: 'AUVON', sub: '贴片', name: '针形贴片 20pack',     sku: 'PO17X4011', productImage: 'https://picsum.photos/seed/cr-patch-20pack/144/144',       productImageAlt: '针形贴片 20pack 主图', review_status: '待审核', bu: '物理治疗', bu_lead: 'Suki', op: 'Jessi', writer: 'Yumi',  launch_date: '2026/02/21', date: '2026/02/12', submit_time: '2026/02/09 08:55:21', review_time: '—' },
  { type: '新品FAQ',     site: 'US', brand: 'ZIKEE', sub: '贴片', name: '医疗款 TENS',         sku: 'PO17X4011', productImage: 'assets/competitor-electrotherapy/comfort-pain-relief.png', productImageAlt: '医疗款 TENS 主图', review_status: '待审核', bu: '北美市场', bu_lead: 'Suki', op: 'Liz',   writer: 'Brian', launch_date: '2026/02/24', date: '2026/02/12', submit_time: '2026/02/09 16:08:52', review_time: '—' },
  { type: '新品FAQ',     site: 'US', brand: 'ZIKEE', sub: '贴片', name: '背光小夜灯',          sku: 'PO17X4011', productImage: 'https://picsum.photos/seed/cr-nightlight-zikee/144/144',   productImageAlt: '背光小夜灯主图', review_status: '待审核', bu: '北美市场', bu_lead: 'Suki', op: 'Liz',   writer: 'Brian', launch_date: '2026/02/25', date: '2026/02/12', submit_time: '2026/02/10 09:18:37', review_time: '—' },
  { type: '新品Listing', site: 'UK', brand: 'AUVON', sub: '药盒', name: '7格旅行药盒（粉色）', sku: 'PO19A2210', productImage: 'https://picsum.photos/seed/cr-pillbox-travel/144/144',     productImageAlt: '7格旅行药盒（粉色）主图', review_status: '待审核', bu: '物理治疗', bu_lead: 'Suki', op: 'Tina',  writer: 'Lucy',  launch_date: '2026/02/26', date: '2026/02/14', submit_time: '2026/02/11 08:42:55', review_time: '—' },
  { type: '新品Listing', site: 'US', brand: 'ZIKEE', sub: '贴片', name: '银色 TENS 套装',      sku: 'PO17X4011', productImage: 'https://picsum.photos/seed/cr-tens-silver/144/144',        productImageAlt: '银色 TENS 套装主图', review_status: '已驳回', bu: '北美市场', bu_lead: 'Suki', op: 'Jessi', writer: 'Yumi',  launch_date: '2026/02/23', date: '2026/02/12', submit_time: '2026/02/09 13:42:08', review_time: '2026/02/10 10:08:55', reject_history: [{ reason: 'Title 核心关键词 weekly pill organizer 位置靠后，建议前置到前 80 字符以内。', time: '2026/02/10 10:08:55', reviewer: 'Suki' }, { reason: '卖点排序偏功能罗列，Bullet 1 应优先回答容量与防洒便携等购买决策点。', time: '2026/02/12 15:22:10', reviewer: 'Susie' }, { reason: 'TD 描述缺少场景化表达，建议补充 travel / daily routine 使用场景。', time: '2026/02/15 09:41:33', reviewer: 'Susie' }] },
  { type: '老品TD',      site: 'UK', brand: 'ZIKEE', sub: '电疗', name: '理疗仪豪华版',        sku: 'PO19B5621', productImage: 'assets/competitor-electrotherapy/seat-cushion-hero.png',   productImageAlt: '理疗仪豪华版主图', review_status: '已驳回', bu: '北美市场', bu_lead: 'Suki', op: 'Tina',  writer: 'Lucy',  date: '2026/02/14', submit_time: '2026/02/11 15:33:04', review_time: '2026/02/12 09:48:21', reject_history: [{ reason: '产品参数描述不准确，需核实 TENS 频率范围与 FDA 认证编号。', time: '2026/02/12 09:48:21', reviewer: 'Tammy' }, { reason: '竞品差异化卖点表述不足，建议增加与 iReliev 和 HealthmateForever 的对比说明。', time: '2026/02/14 11:15:08', reviewer: 'Suki' }] },
  { type: '新品Listing', site: 'US', brand: 'AUVON', sub: '药盒', name: '7格弹跳药盒',         sku: 'PO17X4011', productImage: 'assets/product-pill-box-black.png',                        productImageAlt: '7格弹跳药盒主图', review_status: '已通过', bu: '物理治疗', bu_lead: 'Suki', op: 'Jessi', writer: 'Yumi',  launch_date: '2026/02/20', date: '2026/02/12', submit_time: '2026/02/08 09:32:14', review_time: '2026/04/27 18:27:30' },
  { type: '老品TD',      site: 'US', brand: 'AUVON', sub: '药盒', name: '透明外壳药盒',         sku: 'PO17X4011', productImage: 'https://picsum.photos/seed/cr-pillbox-clear/144/144',      productImageAlt: '透明外壳药盒主图', review_status: '已通过', bu: '物理治疗', bu_lead: 'Suki', op: 'Jessi', writer: 'Yumi',  date: '2026/02/12', submit_time: '2026/02/08 11:48:09', review_time: '2026/02/09 09:25:33' },
...
function copyAuditSubmitNoteKey(row) {
  return [row && row.sku || '', row && row.type || '', row && row.name || ''].join('|');
}

function getCopyAuditSubmitNotes(row) {
  const store = window.AI_SUBMIT_REVIEW_NOTES || {};
  return store[copyAuditSubmitNoteKey(row)] || null;
}

function getCopyAuditListingNote(row, field, idx) {
  const submitted = getCopyAuditSubmitNotes(row);
  if (submitted && submitted.type === 'listing') {
    if (field === 'Title' && submitted.titleNote) return submitted.titleNote;
    if (field === 'TD' && submitted.tdNotes && submitted.tdNotes[idx]) return submitted.tdNotes[idx];
  }
  if (field === 'Title') return '前置核心关键词，提升搜索承接，减少泛化表达。';
  const fallbacks = [
    '把核心购买理由前置，帮助审核人判断卖点排序是否清晰。',
    '补充使用场景表达，让用户更快理解产品适用情境。',
    '强化材质、安全或功能证据，减少空泛表述。',
    '优化语言节奏和合规表达，避免夸大功效。',
    '补充品牌信任与交付完整感，提升结尾转化承接。',
  ];
  return fallbacks[idx] || '补充该条文案的调整点，便于审核人快速判断修改方向。';
}

function getCopyAuditImageNote(row, label, idx) {
  const submitted = getCopyAuditSubmitNotes(row);
  if (submitted && submitted.type === 'imageCopy' && Array.isArray(submitted.imageCopies)) {
    const item = submitted.imageCopies.find(it => it.image === label) || submitted.imageCopies[idx];
    if (item && item.note) return item.note;
  }
  const fallbacks = [
    '强化首图差异化，突出核心卖点和品牌识别。',
    '补充容量与使用场景说明，让用户更快理解购买理由。',
    '突出防洒/结构细节，回应携带过程中的核心顾虑。',
    '补强材质安全表达，提升长期使用信任感。',
    '增加居家、办公、旅行等场景承接，减少画面同质化。',
    '用尺寸和便携性表达降低理解成本，强化“不笨重”的感知。',
    '补充包装与售后信息，提升交付完整感和礼品场景说服力。',
  ];
  return fallbacks[idx] || '补充该图文案的调整点，便于审核人快速判断修改方向。';
}

function getCopyAuditRichTextNote(row) {
  const submitted = getCopyAuditSubmitNotes(row);
  if (submitted && submitted.type === 'imageCopy' && submitted.richTextNote) return submitted.richTextNote;
  return '补充使用场景和证据链，承接图片文案主线。';
}

function renderCopyAuditChangeNote(note) {
  if (!note) return '';
  return `<div class="copy-change-note"><span>修改说明</span><p>${copyReviewEscape(note)}</p></div>`;
}

function getCopyAuditTextTags(row, field) {
  const submitted = getCopyAuditSubmitNotes(row);
  if (submitted && Array.isArray(submitted.textTags)) {
    const realTags = submitted.textTags.filter(item => item.field === field);
    if (realTags.length) return realTags;
  }
  const fallback = {
    Title: [{ tag: '新增', text: 'weekly pill organizer' }],
    'TD-1': [{ tag: '关键词', text: 'BPA-Free' }],
    '主图-图片文案': [{ tag: '新增', text: '7-Day Pill Organizer' }],
    '富文本': [{ tag: '重点审核', text: '长期接触药片' }],
  };
  return fallback[field] || [];
}

function getCopyAuditTagClass(tag) {
  const map = {
    '新增': 'add',
    '修改': 'edit',
    '关键词': 'keyword',
...
function normalizeCopyAuditTagsForText(text, tags) {
  const content = String(text || '');
  return (tags || []).map(item => {
    let start = Number(item.start);
    let end = Number(item.end);
    if (!Number.isInteger(start) || !Number.isInteger(end) || content.slice(start, end) !== item.text) {
      const found = item.text ? content.indexOf(item.text) : -1;
      start = found;
      end = found >= 0 ? found + item.text.length : -1;
    }
...
function renderCopyAuditTaggedText(text, tags, extraClass = '') {
  const content = String(text || '');
  const validTags = normalizeCopyAuditTagsForText(content, tags);
  if (!validTags.length) return `<div class="${extraClass}">${copyReviewEscape(content)}</div>`;
  let cursor = 0;
  let html = '';
  validTags.forEach(item => {
    html += copyReviewEscape(content.slice(cursor, item.start));
    html += `<mark class="copy-inline-tag copy-inline-tag-${getCopyAuditTagClass(item.tag)}"><span>${copyReviewEscape(item.tag)}</span>${copyReviewEscape(content.slice(item.start, item.end))}</mark>`;
    cursor = item.end;
  });
  html += copyReviewEscape(content.slice(cursor));
  return `<div class="${extraClass}">${html}</div>`;
}

function renderCopyAuditTextTags(tags) {
  if (!tags || !tags.length) return '';
  return `<div class="copy-text-tags">
    <div class="copy-text-tags-title">标注内容</div>
    <div class="copy-text-tag-list">
      ${tags.map(item => `<span class="copy-text-tag"><b>${copyReviewEscape(item.tag)}</b>${copyReviewEscape(item.text)}</span>`).join('')}
    </div>
  </div>`;
}

function getCopyAuditSubmittedImageCopy(row, label, idx, fallback) {
  const submitted = getCopyAuditSubmitNotes(row);
  if (submitted && submitted.type === 'imageCopy' && Array.isArray(submitted.imageCopies)) {
    const item = submitted.imageCopies.find(it => it.image === label) || submitted.imageCopies[idx];
    if (item && item.imageCopy) return item.imageCopy;
  }
  return fallback || '';
}

function getImageCreativeRichTextItems(md) {
  const ic = (md && md.imageCreative) || {};
  if (Array.isArray(ic.richTextBlocks) && ic.richTextBlocks.length) {
    return ic.richTextBlocks.map(b => ({
      title: b.title || '',
      content: b.productPoint || '',
    }));
  }
  return Array.isArray(ic.richText) ? ic.richText : [];
}

function getCopyAuditSubmittedRichText(row, fallbackItems) {
  const submitted = getCopyAuditSubmitNotes(row);
  if (submitted && submitted.type === 'imageCopy' && submitted.richText) return submitted.richText;
  return (fallbackItems || []).map(item => `${item.title || ''}\n${item.content || ''}`.trim()).filter(Boolean).join('\n\n');
}
  ...
  foot.innerHTML = mode === 'audit' && row.review_status === '待审核'
    ? `<div class="review-audit-panel">
       ...
       <div class="review-audit-actions">
         <button type="button" class="copy-foot-mark-badge" onclick="requestCopyAuditJumpMarked()">
           已标记 <strong id="copy-foot-mark-count">0</strong>
         </button>
         <button type="button" class="btn btn-secondary" onclick="closeCopyAuditModal()">取消</button>
         <button type="button" class="btn btn-danger" onclick="requestCopyAuditReject('${encodedKey}')">驳回</button>
         <button type="button" class="btn btn-primary" onclick="approveCopyAudit('${encodedKey}')">通过</button>
       </div>`
    : '';
  resetCopyAuditSplit();
  ensureCopyAuditViewToggle(modal);
  setupCopyAuditMobileTabs(body);
  applyCopyAuditViewMode(modal, getCopyAuditViewMode());
  modal.classList.add('show');
}

function getCopyAuditViewMode() {
  try {
    return localStorage.getItem('copyAuditViewMode') === 'mobile' ? 'mobile' : 'pc';
  } catch (e) {
    return 'pc';
  }
}

function ensureCopyAuditViewToggle(modal) {
  const head = modal.querySelector('.review-audit-head');
  if (!head || head.querySelector('.copy-audit-viewtoggle')) return;
  const toggle = document.createElement('div');
  toggle.className = 'copy-audit-viewtoggle';
  toggle.setAttribute('role', 'group');
  toggle.setAttribute('aria-label', '审核视图');
  toggle.innerHTML = `
    <button type="button" data-view="pc" onclick="setCopyAuditViewMode('pc')">PC 版</button>
    <button type="button" data-view="mobile" onclick="setCopyAuditViewMode('mobile')">手机版</button>`;
  const closeBtn = head.querySelector('.review-audit-close');
  if (closeBtn) head.insertBefore(toggle, closeBtn);
  else head.appendChild(toggle);
}

function applyCopyAuditViewMode(modal, mode) {
  const box = modal.querySelector('.copy-audit-box');
  if (!box) return;
  const target = mode === 'mobile' ? 'mobile' : 'pc';
  box.classList.remove('copy-audit-view-pc', 'copy-audit-view-mobile');
  box.classList.add('copy-audit-view-' + target);
  const foot = modal.querySelector('#copy-audit-foot');
  if (foot && target !== 'mobile') foot.classList.remove('copy-foot-sheet-open');
  applyCopyAuditMobileLabels(box, target === 'mobile');
  modal.querySelectorAll('.copy-audit-viewtoggle button').forEach(b => {
    b.classList.toggle('active', b.dataset.view === target);
  });
}

function applyCopyAuditMobileLabels(box, on) {
  if (!box) return;
  box.querySelectorAll('.copy-audit-card-title, .review-outline-title strong, .copy-quick-review > span:first-child').forEach(el => {
    if (!el.dataset.origTitle) el.dataset.origTitle = el.textContent.trim();
    if (!on) {
      el.textContent = el.dataset.origTitle;
      return;
    }
    el.textContent = normalizeCopyAuditMobileTitle(el.dataset.origTitle);
  });
}

function normalizeCopyAuditMobileTitle(text) {
  let title = String(text || '').replace(/^\s*\d+\.\s*/, '').trim();
  title = title.replace(/^提交内容[：:]\s*/, '').trim();
  const map = {
    'AI 评测打分': 'AI 评分',
    'TD': 'TD 文案',
  };
...
function setCopyAuditViewMode(mode) {
  const target = mode === 'mobile' ? 'mobile' : 'pc';
  const modal = document.getElementById('copy-audit-modal');
  if (!modal) return;
  try { localStorage.setItem('copyAuditViewMode', target); } catch (e) {}
  applyCopyAuditViewMode(modal, target);
  if (target === 'mobile') {
    const layout = modal.querySelector('.copy-audit-layout');
    if (layout && !layout.classList.contains('copy-audit-layout-single')
        && !/cr-m-(content|score|ref)/.test(layout.className)) {
      setCopyAuditMobileTab('content');
    }
  }
}

function setupCopyAuditMobileTabs(body) {
  if (!body) return;
  const layout = body.querySelector('.copy-audit-layout');
  if (!layout || layout.classList.contains('copy-audit-layout-single')) return;
  const left = layout.querySelector('.copy-audit-left');
  const right = layout.querySelector('.copy-audit-right');
  if (!left || !right) return;
  const score = left.querySelector('.copy-audit-ai-score');
  if (score) {
    const card = score.closest('.copy-audit-card');
    if (card) card.classList.add('copy-audit-card--score');
  }
  if (!body.querySelector('.copy-audit-mtabs')) {
    const tabs = document.createElement('div');
    tabs.className = 'copy-audit-mtabs';
    tabs.setAttribute('role', 'tablist');
    tabs.innerHTML = `
      <button type="button" class="active" data-mtab="content" onclick="setCopyAuditMobileTab('content')">待审文案</button>
      <button type="button" data-mtab="score" onclick="setCopyAuditMobileTab('score')">AI 评分</button>
      <button type="button" data-mtab="ref" onclick="setCopyAuditMobileTab('ref')">背景资料</button>`;
    layout.parentElement.insertBefore(tabs, layout);
  }
  layout.classList.remove('cr-m-score', 'cr-m-ref');
  layout.classList.add('cr-m-content');
}

function setCopyAuditMobileTab(tab) {
  const modal = document.getElementById('copy-audit-modal');
  if (!modal) return;
  const layout = modal.querySelector('.copy-audit-layout');
  if (!layout) return;
  layout.classList.remove('cr-m-content', 'cr-m-score', 'cr-m-ref');
  layout.classList.add('cr-m-' + tab);
  modal.querySelectorAll('.copy-audit-mtabs button').forEach(b => {
    b.classList.toggle('active', b.dataset.mtab === tab);
  });
  if (tab === 'content') {
    const right = modal.querySelector('.copy-audit-right');
    if (right) right.scrollTop = 0;
  }
}

function requestCopyAuditReject(encodedKey) {
  const modal = document.getElementById('copy-audit-modal');
  const foot = document.getElementById('copy-audit-foot');
  const box = modal && modal.querySelector('.copy-audit-box');
  if (box && box.classList.contains('copy-audit-view-mobile') && foot && !foot.classList.contains('copy-foot-sheet-open')) {
    foot.classList.add('copy-foot-sheet-open');
    const reasonEl = document.getElementById('copy-audit-reject-reason');
    if (reasonEl) setTimeout(() => reasonEl.focus(), 80);
    return;
  }
  rejectCopyAudit(encodedKey);
}

function requestCopyAuditJumpMarked() {
  const modal = document.getElementById('copy-audit-modal');
  if (!modal) return;
  if (typeof setCopyAuditMobileTab === 'function') setCopyAuditMobileTab('content');
  const marked = modal.querySelector('.copy-card-marked');
  if (!marked) {
    showToast('还没有标记问题', 'warning');
    return;
  }
  const body = document.getElementById('copy-audit-body');
  if (body) body.scrollTo({ top: marked.offsetTop - 88, behavior: 'smooth' });
}
...
function getCopyAuditProductContext(row, payload) {
  const productModule = payload && payload.modules
    ? payload.modules.find(m => m.id === 'copy-product')
    : null;
  const moduleProduct = productModule && productModule.product ? productModule.product : null;
  return {
    image: row.productImage || (moduleProduct && moduleProduct.image) || '',
    imageAlt: row.productImageAlt || (moduleProduct && moduleProduct.imageAlt) || row.name || '产品主图',
    sku: row.sku || '—',
    name: row.name || '—',
    brand: row.brand || '—',
    site: row.site || '—',
...
function renderCopyAuditProductContext(row, payload) {
  const esc = copyReviewEscape;
  const ctx = getCopyAuditProductContext(row, payload);
  const thumb = ctx.image
    ? `<a class="copy-audit-product-thumb-btn" href="${esc(ctx.image)}" target="_blank" rel="noopener noreferrer" title="点击查看大图">
        <img class="copy-audit-product-thumb" src="${esc(ctx.image)}" alt="${esc(ctx.imageAlt)}" loading="lazy" />
      </a>`
    : '<div class="copy-audit-product-thumb copy-audit-product-thumb-empty">暂无产品图</div>';
  return `
    <div class="copy-audit-product-context" aria-label="审核对象产品信息">
      ${thumb}
      <div class="copy-audit-product-meta">
        <div class="copy-audit-product-meta-line"><strong>SKU</strong><span>${esc(ctx.sku)}</span></div>
        <div class="copy-audit-product-meta-line copy-audit-product-name"><strong>产品名称</strong><span>${esc(ctx.name)}</span></div>
      </div>
    </div>`;
}
...
function renderCopyAuditHeaderSummary(row, payload) {
  ...
  return `
    <span class="copy-audit-head-summary">
      <span class="copy-audit-field-chip copy-audit-type-chip">需求类型：${esc(row.type || '—')}</span>
      <span class="copy-audit-field-chip copy-audit-sku-chip">SKU：${esc(row.sku || '—')}</span>
      <span class="copy-audit-field-chip copy-audit-priority-chip">优先级：${esc(priority)}</span>
      <span class="copy-audit-row-break"></span>
      <span class="copy-audit-field-chip copy-audit-ai-chip">AI评分：${esc(payload.score.total)}分</span>
      <span class="copy-audit-field-chip copy-audit-brand-chip">品牌：${esc(row.brand || '—')}</span>
      <span class="copy-audit-field-chip copy-audit-site-chip">站点：${esc(row.site || '—')}</span>
          ...
          <div class="copy-td-review-list">
            ${payload.tds.map((td, i) => `
              <div class="copy-td-review-item">
                ...
                ${renderCopyAuditTaggedText(td, getCopyAuditTextTags(row, `TD-${i + 1}`), 'copy-td-text copy-tagged-copy')}
                ${renderCopyAuditTextTags(getCopyAuditTextTags(row, `TD-${i + 1}`))}
                ${renderCopyAuditChangeNote(getCopyAuditListingNote(row, 'TD', i))}
...
function renderImageCopyAuditRight(row, payload) {
  ...
  const md = (typeof MOCK_DATA !== 'undefined') ? MOCK_DATA : {};
  const gallery = (md.imageCreative && md.imageCreative.gallery) || [];
  const richText = getImageCreativeRichTextItems(md);
  return `
    <section class="copy-audit-right copy-audit-submission">
      ${renderCopyAuditProductContext(row, payload)}
      ...
      <div class="copy-audit-card copy-submission-card">
        ...
        <div class="image-copy-submit-list">
          ${gallery.map((it, i) => {
            ...
            const englishCopy = getCopyAuditSubmittedImageCopy(row, label, i, it.imageCopy || '');
            const imageTags = getCopyAuditTextTags(row, `${label}-图片文案`);
            return `
              <div class="image-copy-submit-card" id="image-copy-card-${i}" data-img-target="${esc(label)}">
                ...
                <div class="image-copy-en-block">
                  ${renderCopyAuditTaggedText(englishCopy, imageTags, 'image-copy-en-text copy-tagged-copy')}
                </div>
                ${renderCopyAuditTextTags(imageTags)}
                ${renderCopyAuditChangeNote(getCopyAuditImageNote(row, label, i))}
                ${renderImageCopyIssueButtons(label, label)}
              </div>
            `;
          }).join('')}
        </div>
        <div class="image-copy-submit-richtext">
          <div class="image-copy-submit-title">富文本</div>
          ${renderCopyAuditTaggedText(getCopyAuditSubmittedRichText(row, richText), getCopyAuditTextTags(row, '富文本'), 'image-copy-richtext-preview copy-tagged-copy')}
          ${renderCopyAuditTextTags(getCopyAuditTextTags(row, '富文本'))}
          ${renderCopyAuditChangeNote(getCopyAuditRichTextNote(row))}
        </div>
      </div>
    </section>`;
}
...
function syncImageCopyChipMarks() {
  ...
  bar.querySelectorAll('.image-copy-chip').forEach(chip => {
    ...
    const card = document.querySelector(`.image-copy-submit-card[data-img-target="${t}"]`);
    if (card) card.classList.toggle('copy-card-marked', c > 0);
  });
}
...
function syncImageCopyProgress() {
  ...
  el.textContent = `已审 ${targets.size}/7 张图`;
...
function syncFaqChipMarks() {
  document.querySelectorAll('.faq-copy-chip').forEach(b => {
    ...
    if (card) card.classList.toggle('copy-card-marked', !!has);
  });
}
...
function scrollCopyAuditModule(id) {
  ...
  const el = document.getElementById(id);
  if (!body || !el) return;
  const mobileBox = document.querySelector('#copy-audit-modal .copy-audit-view-mobile');
  if (mobileBox) {
    body.scrollTo({ top: el.offsetTop - 118, behavior: 'smooth' });
    return;
  }
...
function syncCopyAuditHighlight() {
  ...
  modal.querySelectorAll('.copy-card-marked').forEach(el => el.classList.remove('copy-card-marked'));
  ...
  markedTargets.forEach(target => {
    ...
    const markedEl = actionEl.closest('.image-copy-submit-card, .faq-copy-submit-card, .copy-td-review-item, .copy-submission-card');
    if (markedEl) markedEl.classList.add('copy-card-marked');
    if (target === 'Title') {
...
function syncCopyAuditMarkedReason() {
  ...
  const footCountEl = document.getElementById('copy-foot-mark-count');
  if (countEl) countEl.textContent = copyAuditIssueMarks.length;
  if (footCountEl) footCountEl.textContent = copyAuditIssueMarks.length;
  if (!reasonEl) return;
...
function approveCopyAudit(encodedKey) {
  ...
  if (typeof syncDesignTaskOnCopyApprove === 'function' && typeof isDesignSyncCopyType === 'function' && isDesignSyncCopyType(row.type)) {
    ...
    if (task && typeof refreshDesignNotifyBadge === 'function') refreshDesignNotifyBadge();
  }
  closeCopyAuditModal();
...
function selectCopyQuickReview(value) {
  ...
  if (value === '通过') {
    ...
    if (footCountEl) footCountEl.textContent = '0';
    reasonEl.value = '';
...
function openCopyAuditByReviewKey(reviewKey) {
  const key = String(reviewKey || '');
  let row = key ? findCopyReviewRowByKey(key) : null;
  if (!row && key) {
    const parts = key.split('|');
    const sku = parts[1];
    const type = parts[2];
    row = getCopyReviewListData().find(item =>
      item.sku === sku && (!type || item.type === type) && item.review_status === '已驳回'
    ) || getCopyReviewListData().find(item => item.sku === sku);
  }
  if (!row) {
    showToast('未找到对应审核记录（演示数据）', 'warning');
    return;
  }
  openCopyAuditModal(encodeURIComponent(row.review_key), 'detail', {
    title: '驳回记录',
    hideInfo: true,
    auditView: true,
  });
...
window.requestCopyAuditReject = requestCopyAuditReject;
window.requestCopyAuditJumpMarked = requestCopyAuditJumpMarked;
...
window.openCopyAuditByReviewKey = openCopyAuditByReviewKey;
