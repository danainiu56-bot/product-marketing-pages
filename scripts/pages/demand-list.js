...
// 侧边栏菜单结构
const SIDEBAR_MENU = [
  { id: 'workbench', icon: 'workbench', name: '需求看板', single: true },
  ...
  { id: 'design', icon: 'content', name: '设计协同', children: [
    { id: 'design-demand', name: '设计需求' },
  ]},
...
function sortDemandListByStatus(list) {
  const order = { '待审核': 1, '待处理': 2, '已驳回': 3, '已通过': 4, '处理中': 5, '已完成': 6, '已撤回': 7 };
